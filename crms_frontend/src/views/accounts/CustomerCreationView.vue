    ...
    <div class="max-w-7xl mx-auto grid grid-cols-2 gap-4">
        <div class="main-left">
            <div class="p-12 bg-white border border-gray-200 rounded-lg">
                <h1 class="mb-6 text-2xl">Customer Creation</h1>
                ...
                <p class="font-bold">
                    Already have an Account? <router-link :to="{ name: 'login' }" class="underline">Click
                        here</router-link> to log in!
                </p>
            </div>
        </div>
...
export default {
    ...
    setup() {
        ...
        const submitForm = async () => {
            ...
            try {
                const response = await axios.post('/api/accounts/customers', form.value) // Send form data
